...
const USERNAME = process.env.OTHER_OPINION_WORLD_USERNAME;
const PASSWORD = process.env.OTHER_OPINION_WORLD_PASSWORD;
const TELEGRAM_TOKEN = process.env.OTHER_TELEGRAM_TOKEN;
const TELEGRAM_CHAT_ID = process.env.OTHER_TELEGRAM_CHAT_ID;
